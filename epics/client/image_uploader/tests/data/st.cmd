...
epicsEnvSet("SUPPORT","/home/reinier/github/TAUSystems/UT3_Control_And_Data_Acquisition_System/epics/git/support")
epicsEnvSet("TOP","$(SUPPORT)/areaDetector-R3-12-1/ADSimDetector/iocs/simDetectorIOC")
epicsEnvSet("ADSIMDETECTOR","$(SUPPORT)/areaDetector-R3-12-1/ADSimDetector/iocs/simDetectorIOC/../..")

epicsEnvSet("ASYN","$(SUPPORT)/asyn-R4-44-2")
epicsEnvSet("AREA_DETECTOR","$(SUPPORT)/areaDetector-R3-12-1")
epicsEnvSet("ADSUPPORT","$(SUPPORT)/areaDetector-R3-12-1/ADSupport")
epicsEnvSet("ADCORE","$(SUPPORT)/areaDetector-R3-12-1/ADCore")
epicsEnvSet("AUTOSAVE","$(SUPPORT)/autosave-R5-10")
epicsEnvSet("BUSY","$(SUPPORT)/busy-R1-7-2")
epicsEnvSet("CALC","$(SUPPORT)/calc-R3-7-3")
epicsEnvSet("SNCSEQ","$(SUPPORT)/seq-2-2-6")
epicsEnvSet("SSCAN","$(SUPPORT)/sscan-R2-11-6")
epicsEnvSet("DEVIOCSTATS","$(SUPPORT)/iocStats-3-1-16")
epicsEnvSet("EPICS_BASE","/home/reinier/EPICS/epics-base")
...
NDStdArraysConfigure("$(PREFIX)Spectrometer:LowEnergy:Image", 5, 0, "$(PORT)", 0, 0)
# Use this line for 8-bit or 16-bit data
dbLoadRecords("$(ADCORE)/db/NDStdArrays.template", "P=$(PREFIX),R=Spectrometer:LowEnergy:Image:,PORT=$(PREFIX)Spectrometer:LowEnergy:Image,ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),TYPE=Int16,FTVL=SHORT,NELEMENTS=120000")

# Optional: load NDPluginPva plugin
NDPvaConfigure("PVA1", $(QSIZE), 0, "$(PORT)", 0, $(PREFIX)Spectrometer:LowEnergy:PVA:Image, 0, 0, 0)
dbLoadRecords("NDPva.template",  "P=$(PREFIX), R=Spectrometer:LowEnergy:PVA:, PORT=PVA1, ADDR=0, TIMEOUT=1, NDARRAY_PORT=$(PORT)")
...
# Enable Image retrieval. This 
dbpf $(PREFIX)Spectrometer:LowEnergy:PVA:EnableCallbacks 1
dbpf $(PREFIX)Spectrometer:LowEnergy:Image:EnableCallbacks 1
